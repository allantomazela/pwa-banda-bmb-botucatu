...
const PORTAL_NAV = [
  ...
  { name: 'Vídeos', path: '/portal/videos', icon: Video },
]
...
export default function PortalLayout() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] md:min-h-screen bg-background">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-white/5 bg-card/30 fixed h-[calc(100vh-4rem)]">
        <div className="p-6 border-b border-white/5 flex items-center gap-4">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-xs text-muted-foreground truncate">{user.instrument}</p>
          </div>
        </div>
      ...
      {/* Mobile Portal Bottom Nav (replaces public one) */}
