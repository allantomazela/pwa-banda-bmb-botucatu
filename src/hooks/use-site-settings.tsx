...
const DEFAULTS: Record<string, string> = {
  header_title: 'Banda Marcial de Botucatu',
  header_subtitle: 'Tradição, disciplina e honra pela música',
  header_logo_url: '/brand-logo.png',
  hero_title: 'BANDA MARCIAL DE BOTUCATU',
  hero_subtitle:
